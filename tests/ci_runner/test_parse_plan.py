...
from support.ci_runner import parse_plan
...
@pytest.mark.parametrize('output, result', [
    ...
    (
        dedent(
            ...
            ~ module.dd-agent-packaging.github_repository.twindb_repo
                  default_branch: "develop" => "master"

              ~ module.twindb-terraform-modules.github_repository.twindb_repo
                  default_branch: "develop" => "master"
    ...
    (
        dedent(
            ...
            aws_s3_bucket.omnibus-cache-twindb-backup: Refreshing state... (ID: omnibus-cache-twindb-backup)
